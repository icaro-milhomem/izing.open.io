      ...
      <q-item-section avatar
        ...
        <q-avatar size="50px"
          ...
          <img :src="ticket.profilePicUrl"
            ...
            style="background: #ebebeb url('data:image/svg+xml;base64,') no-repeat center">
          <q-icon size="50px"
